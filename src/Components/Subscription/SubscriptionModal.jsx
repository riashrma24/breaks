...
const features = ["Verified users are recognized as authentic and trustworthy, boosting their reputation within the community.", "Posts from verified users get more visibility, leading to higher interactions and responses.", "Verified mentors gain priority access to mentorship features and can attract more mentees.", "Verified users get early access to new platform features and updates."]
                    ...
                    <div className='flex justify-center py-10'>
                        <div className='w-[80%] space-y-10'>
                            <div className='p-5 rounded-md flex items-center justify-between shadow-lg bg-slate-200'>
                                <h1 className='text-xl pr-5'>Subscribers will get a verified mark once they get approved.</h1>
                                <img className='w-24 h-24' src='https://tse1.mm.bing.net/th?id=OIP._dZ88A0U8LlpqYWsWnts8gHaHa&pid=Api&P=0&h=180' />
                            </div>
                            ...
                            <div className='cursor-pointer flex justify-center bg-gray-700 text-white rounded-full px-5 py-3 '>
                                <span className='line-through italic'>₹700.00</span>
                                <span className='px-5'>₹6700 per year</span>
                            </div>
